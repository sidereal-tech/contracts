...
NEXT_PUBLIC_YIELD_SOURCE_RESERVE_ASSET="$YIELD_SOURCE_RESERVE_ASSET"
...
if [[ "$YIELD_SOURCE" == "blend" ]]; then
  ...
  YIELD_SOURCE_RESERVE_ASSET="$BLEND_USDC_ASSET"
  ...
  YIELD_SOURCE_RESERVE_ASSET="${UNDERLYING_ASSET:-}"
